...
import _h  # noqa: E402
from _import_doubles import FakeSecretStore, RaisingLineageEmit, make_service  # noqa: E402
...
def _req(payload, op="op1"):
    return ImportRequest(
        tenant_id="t1",
        source=SourceDescriptor(kind=SourceKind.CSV, ref="f", payload=payload),
