...
def cmd_run(_args: argparse.Namespace) -> int:
    ...
    #
    # It drove `Gateway -> internal dispatch edge -> composed DatabaseRouter.route() -> durable routing audit`.
    ...
    #     (`git show 8719f4f3:backend/tests/control_plane/requires_pg/dbr_ar_2d_standing_witnesses.py`);
    #   * the file surface this harness belongs to is pinned by its own governance guards, which
    #     are about the DBR-AR-2D/2E evidence surface — not about the Gateway — and deleting the file would break
