...
from doubles import FakeAudit, FakeConnectionFactory, FakeRoutingRead, FakeSecretStore  # noqa: E402
...
def _router(*, bulk_max=2, inter_max=5):
    ...
    router = DatabaseRouter(
        resolver=resolver, pool=interactive, secret_store=FakeSecretStore(),
        connection_factory=FakeConnectionFactory(), audit=FakeAudit(), bulk_pool=bulk,
    )
