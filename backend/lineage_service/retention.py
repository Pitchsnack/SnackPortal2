...
class RetentionFramework:
    ...
    def evaluate(self, ctx: RequestContext, policy: Optional[RetentionPolicy] = None) -> RetentionDecision:
        ...
        detail = "retain (expiry disabled in Build Phase 6)" if configured else "retain-all (D-08 retention values pending)"
    ...
    def expire(self, *args: object, **kwargs: object) -> None:
        ...
        raise RetentionDisabled("expiry/deletion/crypto-erase disabled until approved D-08 retention values")
