...
**Resolved to date:** D-01–D-05 (foundational), D-07, D-13–D-17 (tenant infrastructure), D-08, D-22–D-25 (lineage), D-18–D-21 + D-09 (ingress) (import), D-06, D-10–D-12, D-30 + JWT lifecycle (finalization), **D-31, D-32 (post-freeze amendments, Approved)**, and **D-33–D-36 (Workspace-Architecture governance package, Approved 2026-06-12 via PRD-D33-D36-P1-R1; D-34 amends D-20 in part; D-35 extends D-31)**. See the register above. **D-37 (Portal Contract Architecture) is the pending fifth package decision — required before any portal/frontend-integration work.**
