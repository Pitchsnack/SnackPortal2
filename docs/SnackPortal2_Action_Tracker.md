...
| 36 | **Stage 5 — Import/Lineage write path + `year_founded` contract fix** | High | ✅ | **PASS, 2026-08-23**, on `rebuild/fastapi-openapi-first` (`f677e1268` → `9c49dcde5`, four local commits, **unpushed**). Closes Stage 4 blocker B-1 (35a) and finding F-3 (35b). 235 live tests pass against the four disposable PostgreSQL 17.10 clusters (was 218); full hermetic suite 2283 (was 2253); ruff/mypy/lint-imports green; all 14 OpenAPI 3.1 gates PASS and unchanged under live PostgreSQL configuration. Report: `Treebranch2/PRD/PFD1/Claude_Stage5_Import_Lineage_YearFounded_FINAL_Status_Report.md`. **Awaiting Dan.** |
